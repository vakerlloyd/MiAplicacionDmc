...
class EstudianteCurso:
    ...
    def estado_academico(self, nota_minima=11.0, asistencia_minima=75.0):
    ...
    def get_datos(self):
        return {
            ...
            "peso_actividades": self.peso_actividades,
            "peso_proyecto": self.peso_proyecto,
            "peso_examen_final": self.peso_examen_final,
            "total_clases": self.total_clases,
            "clases_asistidas": self.clases_asistidas
        }
    
    def set_datos(self, nombre, actividades, proyecto, examen_final, peso_actividades, peso_proyecto, peso_examen_final, total_clases, clases_asistidas):
        self.nombre = nombre
        self.actividades = actividades
        self.proyecto = proyecto
        self.examen_final = examen_final
